...
def test_tile_api_endpoints():
    # Use the context manager so the lifespan runs and db_pool is initialised.
    # Without it Starlette 1.x skips the lifespan, leaving db_pool=None and
    # causing vector-tile endpoints to fail with AttributeError.
